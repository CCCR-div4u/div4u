...
class SecurityValidator:
    ...
    def scan_for_sensitive_data(self) -> List[str]:
        ...
        excluded_vars = {
            ...
            'GITHUB_WORKFLOW_SHA', 'GITHUB_HEAD_REF', 'GITHUB_BASE_REF', 'GITHUB_REF_NAME',
            'GITHUB_REF_TYPE', 'GITHUB_EVENT_PATH', 'GITHUB_ACTION', 'GITHUB_ACTION_PATH',
            'GITHUB_ACTION_REPOSITORY', 'GITHUB_ACTIONS', 'GITHUB_WORKFLOW',
            'GITHUB_JOB', 'GITHUB_STEP_SUMMARY', 'GITHUB_SERVER_URL', 'GITHUB_API_URL',
            'GITHUB_GRAPHQL_URL', 'GITHUB_RETENTION_DAYS', 'GITHUB_REPOSITORY_OWNER',
            'RUNNER_OS', 'RUNNER_ARCH', 'RUNNER_NAME', 'RUNNER_WORKSPACE', 'RUNNER_TEMP',
            'RUNNER_TOOL_CACHE', 'RUNNER_TRACKING_ID', 'RUNNER_PERFLOG', 'RUNNER_ENVIRONMENT'
        }
